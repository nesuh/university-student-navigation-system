...
function bootstrap() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var app, config, documentFactory, port;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    app = _b.sent();
                    app.useGlobalFilters(new exception_1.GlobalExceptionFilter());
                ...
                case 2:
                    _b.sent();
                    common_1.Logger.debug(process.env.BASE_URL + ":" + port + "/docs", 'Swagger Docs');
                    return [2 /*return*/];
            }
        });
    });
