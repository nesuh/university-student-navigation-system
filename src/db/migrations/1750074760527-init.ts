...
export class Init1750074760527 implements MigrationInterface {
    name = 'Init1750074760527'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Library" ("tenantId" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" SERIAL NOT NULL, "name" character varying NOT NULL, "headOfLibrary" character varying NOT NULL, "capacity" integer NOT NULL, "operationalTime" jsonb NOT NULL, "buildingId" integer, CONSTRAINT "UQ_4b6fc28b033cb537770df6387e1" UNIQUE ("name"), CONSTRAINT "PK_4c554e3566b62825de70121da37" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Library" ADD CONSTRAINT "FK_ea0540ee159ed8709e386118a87" FOREIGN KEY ("buildingId") REFERENCES "building"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "Library" DROP CONSTRAINT "FK_ea0540ee159ed8709e386118a87"`);
